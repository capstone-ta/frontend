            ...
            <div className="flex-1 flex flex-col pt-5 pb-4 overflow-y-auto">
               <div className="flex-1 px-3 bg-white divide-y space-y-1">
                  <ul className="space-y-2 pb-2">
                     <li>
                        <a href="/dashboard/" className={clicked === "dashboard" ?"bg-indigo-500 text-gray-100 hover:bg-indigo-700 " + baseClass  : "text-gray-500 hover:bg-gray-100 " + baseClass}>
                     ...
                     <li>
                        <a href="/dashboard/pengujian" className={clicked === "pengujian" ?"bg-indigo-500 text-gray-100 " + baseClass  : "text-gray-500 hover:bg-gray-100 hover:bg-gray-100 " + baseClass}>
                     ...
                     <li>
                        <a href="/dashboard/konfigurasi" className={clicked === "konfigurasi" ?"bg-indigo-500 text-gray-100 " + baseClass  : "text-gray-500 hover:bg-gray-100 " + baseClass}>
                     ...
                     <li>
                        <a href="/dashboard/user" className={clicked === "pengguna" ?"bg-indigo-500 text-gray-100 " + baseClass  : "text-gray-500 hover:bg-gray-100 " + baseClass}>
                           ...
                           <span className="ml-3 flex-1 whitespace-nowrap">Pengguna</span>
                        </a>
                     </li>
                     <li>
                        <a href="/" className={clicked === "-" ?"bg-indigo-500 text-gray-100 " + baseClass  : "text-gray-500 hover:bg-gray-100 " + baseClass}>
                           <svg className={clicked === "-" ? "text-gray-100 " + baseImage : "text-gray-500 " + baseImage} fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <div className="space-y-2 pt-2">
                        <a href="/" className={clicked === "keluar" ?"bg-indigo-500 text-gray-100 " + baseClass  : "text-gray-500 hover:bg-gray-100 " + baseClass}>
