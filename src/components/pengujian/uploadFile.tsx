...
const FileUploadComponent: React.FC<{ jwt: string }> = ({ jwt }) => {
  ...
  return (
    <div className="flex flex-col items-center justify-center mt-10 bg-white rounded-lg w-10/12 mx-auto p-6">
      <h2 className="text-lg font-semibold mb-4 text-center">Analisis Pengukuran</h2>
      ...
      <button
        ...
        className="bg-indigo-500 hover:bg-indigo-700 text-gray-100 cursor-pointer px-4 py-2 rounded-md shadow-md hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 mt-4"
